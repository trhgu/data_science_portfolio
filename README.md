...
- [classify the theme of news articles(fastcampus data science class with park)](https://github.com/trhgu/TIL/blob/master/news_ariticle_calssification.ipynb) : Produce Naive Bayes model to classify theme of news articles. (Text vectorizer : TF-IDF)
